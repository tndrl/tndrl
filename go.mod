...
require (
	...
	github.com/cloudwego/eino-ext/components/model/claude v0.1.12 // indirect
...
replace github.com/mark3labs/mcphost => github.com/shanemcd/mcphost v0.0.0-20251226215156-d128d1cd10db
